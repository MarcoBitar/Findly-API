...
CREATE TABLE `leaderboards` (
  ...
  UNIQUE KEY `leaderbord_id_UNIQUE` (`leaderboard_id`),
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `fk_user_id_leaderboard` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `leaderboards` VALUES (1,'2024-11-08',600,1);
